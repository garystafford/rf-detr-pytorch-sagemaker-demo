...
instances = [
    'ml.g4dn.xlarge', 'ml.g5.xlarge', 'ml.g6.xlarge',
    'ml.g4dn.xlarge', 'ml.g5.xlarge', 'ml.g6.xlarge',
    'ml.g4dn.xlarge', 'ml.g5.xlarge', 'ml.g6.xlarge'
]
...
fig = go.Figure(data=[go.Table(
    ...
    header=dict(
        values=['<b>Instance</b>', '<b>Users</b>', '<b>Latency (ms)</b>', '<b>RPS</b>', '<b>GPU %</b>'],
        fill_color='#34495E',
    ...
    cells=dict(
        values=[instances, users, latency, rps, gpu],  # Each column as separate list
...
fig.write_image(
    "sagemaker_performance_table.png",
    width=750,
    height=550,
    scale=2
)
